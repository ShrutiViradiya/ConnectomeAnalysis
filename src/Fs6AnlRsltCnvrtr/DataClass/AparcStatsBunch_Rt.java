 ...
 */
public class AparcStatsBunch_Rt extends Bunch {

    public static void main(String[] args) {
        String folder_path_str = "file:/C:/Users/issey/Documents/Dropbox/docroot/20161124_FS6_ANL_RSLT";

        //コンストラクタ
        AparcStatsBunch_Rt bas = new AparcStatsBunch_Rt(folder_path_str);
        System.out.println(bas.getListOf_SubjectName());
        System.out.println(bas.getListOf_Superiorfrontal_Vol());
        System.out.println(bas.getListOf_CortexVol());
        System.out.println();
    }

    //読み取り対象ファイル絞込用フィルタに使う文字列
    static String FilteringString = "rh.aparc.DKTatlas.stats";
    ...
    public AparcStatsBunch_Rt(String aparc_stats_folder_path) {
        //スーパークラスのコンストラクト
