 ...
 * @author issey
 */
public class CollectionWriterAndReader_ver6 {
    /**
     * テストメソッド
     *
     * @param args
    ...
    public static void load_test(String[] args) {
        //テキストファイルからの読み込み
        CollectionWriterAndReader_ver6 tmo = new CollectionWriterAndReader_ver6();
    ...
    public static void outputToTextfile(TreeMap<String, String> tm, File file) {
        ...
        try {
            ...
            Logger.getLogger(CollectionWriterAndReader_ver6.class.getName()).log(Level.SEVERE, null, ex);
        }
