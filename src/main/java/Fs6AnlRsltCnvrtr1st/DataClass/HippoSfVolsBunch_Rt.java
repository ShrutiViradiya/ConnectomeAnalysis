 ...
 */
public class HippoSfVolsBunch_Rt extends Bunch {
    ...
    public static void main(String[] args) {
        ...
        //コンストラクタ
        HippoSfVolsBunch_Rt bunch = new HippoSfVolsBunch_Rt(folder_path_str);
    ...
    static String FilteringString = "rh.hippoSfVolumes-T1.v10.txt";
    ...
    public HippoSfVolsBunch_Rt(String hippo_sf_vols_folder_path) {
        //スーパークラスのコンストラクト
