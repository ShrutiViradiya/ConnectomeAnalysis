 ...
 * @author issey
 */
public class RandomNetworkMaker_ver2 {

    static String output_folder_path = "output_files/ArrangedT182CData/RandomNetwork_by_TrimedMean";
    static String input_file_path = "output_files/ArrangedT182CData/TotalEdgeCountList_of_BinarizedNetwork.txt";
    ...
    public static void main(String[] args) {
        ...
        while (it.hasNext()) {
            ...
            try {
                ...
                new RandomNetworkMaker_ver2().saveGraph(output_folder_path + "\\" + name_of_newfile);
